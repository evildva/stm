...
static void gpu_fill(lv_color_t * dest_buf, lv_coord_t dest_width,const lv_area_t * fill_area, lv_color_t color);
#endif
 ...
 * It can be used only in buffered mode (LV_VDB_SIZE != 0 in lv_conf.h)*/
static void gpu_fill(lv_color_t * dest_buf, lv_coord_t dest_width,
